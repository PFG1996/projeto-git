...
require_once($_SERVER['DOCUMENT_ROOT'] . "/projeto/model/conexao.class.php");
...
$array_usuario = array(
    ...
    "autor" => Crud::criptoautor("senacrs"),
    "data_nasc" => "2000/06/12"
);

$noticia = new Crud("usuario");
$resposta = $noticia->insereCrud($array_usuario);
if ($resposta) {
...
$resposta = $noticia->selectCrud("*", true, $array_where);
echo "<pre>";
print_r($resposta);
echo "</pre>";
...
$resposta = $noticia->selectCrud("*", true, $array_where, "like");
echo "<pre>";
print_r($resposta);
echo "</pre>";
...
$array_where = array(
    "email" => "beltrano@gmail.com",
    "autor" => Crud::criptoautor("senacrs2")
);
$resposta = $noticia->selectCrud("*", true, $array_where);
if ($resposta) {
    echo "Logado <br>";
} else {
    echo "Login ou autor incorretos <br>";
}
...
$resposta = $noticia->excluiCrud($array_id);
if ($resposta) {
